...
import ch.asit_asso.extract.batch.writer.ImportedRequestsWriter;
import ch.asit_asso.extract.persistence.ApplicationRepositories;
import ch.asit_asso.extract.batch.processor.ProductsProcessor;
...
public class CommandImportJobRunner /*extends JobRunner<Product, Request>*/ implements Runnable {
    ...
    public final ProductsProcessor getProcessor() {
        ...
        return new ProductsProcessor(repository.findById(this.connectorId).orElse(null));
    }
