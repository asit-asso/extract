...
public class RequestMatcher {
    ...
    private void initAssignements() {
        ...
        for (ScriptEngineFactory engine : factory.getEngineFactories()) {
            this.logger.debug("Available engine {} with extensions {} and MIME types {}",
                    engine.getEngineName(), String.join(", ", engine.getExtensions()),
                    String.join(", ", engine.getMimeTypes()));
        }
        this.engine = factory.getEngineByExtension("js");
