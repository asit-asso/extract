 ...
 * @author Florent Krin
 */
public class QGISPrintRequest implements ITaskProcessorRequest {
     ...
     */
    public QGISPrintRequest(final ITaskProcessorRequest originalRequest) {
