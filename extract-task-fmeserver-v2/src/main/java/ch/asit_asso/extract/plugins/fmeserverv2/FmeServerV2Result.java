...
/**
 * The outcome of an FME Server V2 process task.
 *
 * @author Extract Team
 */
public class FmeServerV2Result implements ITaskProcessorResult {
    ...
    /**
     * Creates a new FME Server V2 result instance.
     */
    ...
    /**
     * Gets the path where the result files are stored.
     *
    ...
    /**
     * Sets the path where the result files are stored.
     *
    ...
    public final String toString() {
        return String.format("FmeServerV2Result[ status : %s, errorCode : %s, message : %s, resultFilePath : %s]", 
